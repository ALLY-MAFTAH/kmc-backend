                    ...
                    <div class="row">
                        <div class="col">
                            <div class=" text-left">
                                <h5 class="my-0">
                                    <span class="">
                                        <small>{{ __('Susmall-Wards Under Kinondoni Municipal') . ' - ' }}
                                        </small>
                ...
                <div class="card-body">
                            ...
                            <div class="card mb-1 p-2" style="background: var(--form-bg-color)">
                                <form method="POST" action="{{ route('sub_wards.add') }}">
                                    ...
                                    <div class="row">
                                        <div class="col mb-1">
                                            <label for="ward_id"
                                                class=" col-form-label text-sm-start">{{ __('Ward') }}<span
                                                    class="text-danger"> *</span></label>
                                            <select id="ward_id" type="text"
                                                class="form-control form-select @error('ward_id') is-invalid @enderror"
                                                name="ward_id" value="{{ old('ward_id') }}" required autocomplete="ward_id"
                                                autofocus>
                    ...
                    <div class="table-responsive-lg">
                        <table id="data-tebo1"
                            ...
                            <tbody>
                                @foreach ($subWards as $index => $subWard)
                                    <tr>
                                        ...
                                        <td class="text-center d-flex justify-content-between text-center">
                                            ...
                                            <a href="#" class="btn  btn-outline-danger mx-2"
                                                onclick="if(confirm('Are you sure want to delete {{ $subWard->name }}?')) document.getElementById('delete-ward-{{ $subWard->id }}').submit()">
                                                Delete
                                            </a>
                                            <form id="delete-ward-{{ $subWard->id }}" method="post"
