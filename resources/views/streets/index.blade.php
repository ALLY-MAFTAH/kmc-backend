                    ...
                    <div class="row">
                        <div class="col">
                            <div class=" text-left">
                                <h5 class="my-0">
                                    <span class="">
                                        <small>{{ __('Streets Under Kinondoni Municipal') . ' - ' }}
                                        </small>
                        ...
                        <div class="col text-right">
                            <a href="#" class="btn  btn-outline-primary collapsed" type="button"
                                ...
                                <i class="feather icon-plus"></i> Add New Street
                        ...
                        <div class="accordion-body">
                            <div class="card mb-1 p-2" style="background: var(--form-bg-color)">
                                <form method="POST" action="{{ route('streets.add') }}">
                                    ...
                                    <div class="row">
                                        <div class="col mb-1">
                                            <label for="sub_ward_id" class=" col-form-label text-sm-start">{{ __('Sub-Ward') }}<span class="text-danger"> *</span></label>
                                            <select id="sub_ward_id" type="text"
                                                ...
                                                @foreach ($subWards as $subWard)
                                                    <option value="{{ $subWard->id }}">{{ $subWard->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('sub_ward_id')
                                ...
                                @foreach ($streets as $index => $street)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form id="toggle-status-form-{{ $street->id }}" method="POST" class="mx-3"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Edit Street
                                                            </h5>
