<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('owners.edit', $owner) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="text-start col mb-1">
                    ...
                    <div class="">
                        <input id="first_name" type="text" placeholder="First Name"
                            ...
                            value="{{ old('first_name', $owner->first_name) }}"required autocomplete="first_name"
                            autofocus>
                        @error('first_name')
                ...
                <div class="text-start col mb-1">
                    ...
                    <div class="">
                        <input id="middle_name" type="text" placeholder="Middle Name"
                            ...
                            value="{{ old('middle_name', $owner->middle_name) }}" autocomplete="middle_name" autofocus>
                        @error('middle_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="text-start col mb-1">
                    ...
                    <div class="">
                        <input id="last_name" type="text" placeholder="Last Name"
                            ...
                            value="{{ old('last_name', $owner->last_name) }}"required autocomplete="last_name"
                            autofocus>
                        @error('last_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                ...
                <div class="text-start col mb-1">
                    ...
                    <div class="">
                        <input id="nida" type="number" placeholder="NIDA"
                            ...
                            value="{{ old('nida', $owner->nida) }}"required autocomplete="nida" autofocus>
                        @error('nida')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="text-start col mb-1">
                    ...
                    <div class="">
                        <input id="mobile" type="number" placeholder="Eg; 0712345678" maxlength="10"
                            ...
                            name="mobile" value="{{ old('mobile', $owner->mobile) }}"required autocomplete="phone"
                            autofocus>
                        @error('mobile')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
