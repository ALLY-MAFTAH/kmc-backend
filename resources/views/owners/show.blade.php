...
@section('content')
    <div class="page-wrapper mdc-toolbar-fixed-adjust">
                        ...
                        <div class="row">
                            <div class="col-3 leftProfSide">
                                <div class="ml-2"
                                    ...
                                    <img src="{{ asset('storage/' . $owner->photo) }}" alt="" style="width: 100%;"
                                        onerror="this.onerror=null; this.src='{{ asset('../images/user.png') }}';">
                                </div>

                                <div class="contBtns py-3 ml-2">
                                    <button href="#" data-bs-toggle="modal"
                                        data-bs-target="#messageModal-{{ $owner->id }}" class=" text-center contactBtn"
                ...
                <div class="card-body">
                    <div class="table-responsive-lg">
                        <table id="data-tebo1"
                            ...
                            <tbody>
                                @foreach ($owner->vehicles as $index => $vehicle)
                                    <tr>
                ...
                <div class="card-body">
                    <div class="table-responsive-lg">
                        <table id="data-tebo2"
                            ...
                            <tbody>
                                @foreach ($owner->alerts as $index => $alert)
                                    <tr>
                                        <td class="text-center" style="max-width: 20px">{{ ++$index }}</td>
                                        <td>{{ $alert->date }}</td>
        ...
        <div class="modal modal-sm fade" id="messageModal-{{ $owner->id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal modal-lg fade" id="edit_owner_modal-{{ $owner->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Owner Info
                        </h5>
                        <button type="button" class="btn btn-danger btn-sm btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
        ...
        <div class="modal modal-lg fade" id="mapModal-{{ $owner->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{ $owner->name }} Location
                        </h5>
                        <button type="button" class="btn btn-danger btn-sm btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
