...
<head>
    <title> Reset Password | {{ config('app.name', 'Smart Kinondoni') }}</title>
    ...
    <div class="container">
        <div class="myCard">
            <div class="row">
                <div class="col-sm-6">
                    <div class="myLeftCtn">
                        <form class="myForm text-center" method="POST" action="{{ route('password.update') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <i class="fas fa-lock"></i>
                                <input class="myInput form-control @error('password_confirmation') is-invalid @enderror"
                            ...
                            <div class="form-group pl-4">
                                <input type="submit" class="butt" value="RESET PASSWORD">
                                <br><br>
