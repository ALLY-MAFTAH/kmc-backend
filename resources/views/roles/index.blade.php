                                ...
                                @foreach ($roles as $index => $role)
                                    <tr>
                                                    ...
                                                    <div class="mdc-switch__thumb-underlay">
                                                        <div class="mdc-switch__thumb">
                                                            ...
                                                            <input type="checkbox" name="status"
                                                                id="bassic-status-switch-{{ $role->id }}"@if ($role->status) checked @endif
                                        ...
                                        <td class="text-center d-flex justify-content-between text-center">
                                            ...
                                            <div class="modal modal-sm fade" id="editModal-{{ $role->id }}"
                                            ...
                                            <form id="delete-role-{{ $role->id }}" method="post"
                                                action="{{ route('roles.delete', $role) }}">@csrf
                                                @method('delete')
                                            </form>
                                        </td>
